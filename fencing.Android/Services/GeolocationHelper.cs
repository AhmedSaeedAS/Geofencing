    ...
    public class GeolocationHelper
    {
        ...
        public static void StopLocationService()
        {
            try
            {
                ...
                System.Diagnostics.Debug.WriteLine("StopLocationService");

                // Unbind from the LocationService; otherwise, StopSelf (below) will not work:
                if (LocationServiceConnection != null)
                {
                    System.Diagnostics.Debug.WriteLine("Unbinding from LocationService");
                ...
                {
                    System.Diagnostics.Debug.WriteLine("Stopping the LocationService");
                    Current.LocationService.StopSelf();
                }
            }
            catch (Exception ex)
            {
                System.Diagnostics.Debug.WriteLine($"Error stopping location service: {ex.Message}");
            }
        }
        #endregion
    }
